...
import TemplateProject_DevSupport
...
final class ReactInstance: NSObject, RNXHostConfig {
    ...
    func initReact(bundleRoot: String?, onDidInitialize: @escaping () -> Void) {
        if host != nil {
            ...
            RCTTriggerReloadCommandListeners("TemplateProject")
            return
        }
        ...
        NotificationCenter.default.post(
            name: .TemplateProjectWillInitializeReactNative,
            object: nil
        )
        ...
        NotificationCenter.default.post(
            name: .TemplateProjectDidInitializeReactNative,
