...
import { readJSONFile } from "./helpers.mjs";
        ...
        $defs: {
            ...
            component: {
                ...
                properties: {
                    ...
                    initialProperties: {
                        description:
                            "Properties that should be passed to your component.",
                        type: "object",
                    },
                    presentationStyle: {
                        description:
                            "The style in which to present your component.",
                        type: "string",
                        enum: ["default", "modal"],
                    },
                    slug: {
        ...
        properties: {
            ...
            macos: {
                ...
                properties: {
                    applicationCategoryType: {
                        description: extractBrief(
                            docs["macos.applicationCategoryType"],
                        ),
                        markdownDescription:
                            docs["macos.applicationCategoryType"],
                        type: "string",
                    ...
                    humanReadableCopyright: {
                        description: extractBrief(
                            docs["macos.humanReadableCopyright"],
                        ),
                        markdownDescription:
                            docs["macos.humanReadableCopyright"],
                        type: "string",
            ...
            windows: {
                ...
                properties: {
                    ...
                    certificateKeyFile: {
                        description: extractBrief(
                            docs["windows.certificateKeyFile"],
                        ),
                    ...
                    certificatePassword: {
                        description: extractBrief(
                            docs["windows.certificatePassword"],
                        ),
                        markdownDescription:
                            docs["windows.certificatePassword"],
                        type: "string",
                    ...
                    certificateThumbprint: {
                        description: extractBrief(
                            docs["windows.certificateThumbprint"],
                        ),
                        markdownDescription:
                            docs["windows.certificateThumbprint"],
                        type: "string",
